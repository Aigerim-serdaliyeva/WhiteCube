    ...
    foreach ($user_photos->data as $post) {
      ...
      $html .= '<div class="insta">
          <div class="insta__head">
              <a class="insta__logo" href="https://instagram.com/'.$username.'" data-ios-link="user?username='.$username.'" data-log-event="profilePhotoClick" target="_blank">
                  <img src="' . $post->user->profile_picture . '" />
              </a>
              <a class="insta__name" href="https://instagram.com/'.$username.'" data-ios-link="user?username='.$username.'" data-log-event="profilePhotoClick" target="_blank">
                  ' . $post->user->username . '
              </a>
              <a class="insta__btn" href="https://instagram.com/'.$username.'" data-ios-link="user?username='.$username.'" data-log-event="profilePhotoClick" target="_blank">
                  Посмотреть профиль
              </a>
          </div>
